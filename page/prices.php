...
<div id="price-container">
    ...
    <div class="price-item">
        <div class="price-subitem1">Mutes dobuma skalošana ar ozonētu fizioloģisko šķīdumu</div>
        <div class="price-subitem2">25 &euro;</div>
    </div>
    <div class="price-item">
        <div class="price-subitem1">Mutes dobuma injekcijas ar ozonētu fizioloģisko šķīdumu paradantoza ārstēšanai</div>
        <div class="price-subitem2">40 &euro;</div>
    </div>
    <div class="price-item">
        <div class="price-subitem1">Aplikācija ar ozonētu eļļu paradantoza ārstēšanai</div>
        <div class="price-subitem2">25 &euro;</div>
    </div>
    <div class="price-item">
